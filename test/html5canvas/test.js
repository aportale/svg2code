...
var test_elements = {
    'cat': { id: 'cat', bounds: { x: 374.4, y: 184.0, width: 93.2, height: 77.3 }, drawfunction: test_draw_000 },
    'dog': { id: 'dog', bounds: { x: 272.2, y: 183.4, width: 91.2, height: 76.1 }, drawfunction: test_draw_001 }
}

function test_draw(context, id, x, y, width, height)
{
    var element = test_elements[id];
