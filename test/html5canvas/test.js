...
var test = {
    elements: {
        'cat': { id: 'cat', bounds: { x: 374.4, y: 184.0, width: 93.2, height: 77.3 }, drawfunction: function(c) {
            c.beginPath();
        ...
        'dog': { id: 'dog', bounds: { x: 272.2, y: 183.4, width: 91.2, height: 76.1 }, drawfunction: function(c) {
            c.beginPath();
